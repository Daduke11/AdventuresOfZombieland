...
class King extends FlxSprite
{
	...
	private static var ENEMY_WIDTH:Int = 12;
	...
	public function new(tilemap:FlxTilemap, hero:FlxSprite) 
	{
		...
		loadGraphic("assets/images/king.png", true, ENEMY_WIDTH, ENEMY_HEIGHT);
		animation.add("down", [0, 1, 2, 3]);
		animation.add("up", [12, 13, 14, 15]);
		animation.add("right", [8, 9, 10, 11]);
		animation.add("left", [4, 5, 6, 7]);
